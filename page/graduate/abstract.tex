...
随着智能交通系统与自动驾驶技术的快速发展，移动机器人在复杂实际环境中的轨迹跟踪控制问题的重要性日益凸显。受控制延迟、执行器性能退化以及外界扰动等非理想因素影响，系
...
\begin{enumerate}
    ...
    \item 构建基于在线稀疏高斯过程回归与模型预测控制深度融合的轨迹跟踪控制框架（GP-MPC）。通过在线学习名义模型的残差动力学，实现对控制延迟、执行器异常及环
